import profilePic from "../assets/AdarshPic.jpg";
    ...
    <div className="pb-4 lg:mb-36">
      <div className="flex flex-wrap lg:flex-row-reverse">
        <div className="w-full lg:w-1/2">
          <motion.img
            src={profilePic}
            alt="Adarsh Kumar Srivastava"
            className="border border-stone-900 rounded-3xl" width={650} height={650} initial={{ x: 100, opacity: 0}} animate={{x: 0, opacity: 1}} transition={{ duration: 1, delay: 1.5}}
          />
        </div>
        <div className="w-full lg:w-1/2">
